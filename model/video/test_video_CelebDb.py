# =============================================================================
# test_video_Celeb-DB.py
# Cross-dataset evaluation for Video Model (Celeb-DB)
#
# Outputs:
...
DEFAULT_ROOT_DIR = (
    r"F:\Experiments\Mtech Project DeepFaked Video and Audio analyzer\Data\Video\CelebDF" 
)
...
DEFAULT_OUTPUT_DIR = (
    ...
    r"\Models\video\eval_outputs\CelebDB"
)
